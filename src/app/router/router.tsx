...
import { setDataUser, setFarmOnline, setSettings } from "@/redux/features/userSlice"
...
const Router = () => {
    ...
    if (!isMobile) {
        return <div style={{width: "100dvw", height: "100dvh", background: "black", position: "fixed", left: 0, top: 0, zIndex: 99999, display: "flex", justifyContent: "center", alignItems: "center"}}>Доступ с компьютеров запрещен</div>;
    }

    useEffect(() => {
        axios.post(`${url_api}user/login`, {id_telegram: idUserTelegram, refid: 2}).then((response:any) => {
